...
namespace Api_Inventariobiblioteca.Controllers
{
    ...
    public class LibroController : ControllerBase
    {
        ...
        public async Task<ActionResult<APIResponse>> CrearAutor([FromBody] LibroCreatedDto ModelLibro)
        {
            try
            {
                if (ModelLibro == null)
                ...
                Libro creado = await _Librorrepo.Listar(c => c.NombreLib == ModelLibro.NombreLib);
